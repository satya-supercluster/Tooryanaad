...
var Register = require("../model/registration"); //middleware
...
router.post("/Reg", function _callee(req, res) {
  var users, email, existingUser, newUser, pdfBuffer, transporter, mail;
  return regeneratorRuntime.async(function _callee$(_context2) {
    while (1) {
      switch (_context2.prev = _context2.next) {
        ...
        case 15:
          _context2.next = 17;
          return regeneratorRuntime.awrap(generatePDF(users));
